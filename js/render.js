...
var PortfolioRender = (function () {
    ...
    function renderHero() {
        ...
        var bioHtml = p.bio.map(function (para, i) { return '<p data-i18n="bioPara' + (i + 1) + '">' + esc(para) + '</p>'; }).join('');
        ...
        fill('section1',
            ...
            +     '<p class="hero-lead" data-i18n="heroLead">' + esc(p.lead) + '</p>'
            ...
            +     '<span class="section-eyebrow" data-i18n="aboutEyebrow">Who I Am</span>'
    ...
    function renderHighlights() {
        ...
        fill('section-highlights',
            '<div class="container">'
            + '<div class="section-heading">'
            +   '<span class="section-eyebrow" data-i18n="hlEyebrow">Career Snapshot</span>'
            +   '<h2 data-i18n="hlTitle">Key Highlights</h2>'
            + '</div>'
    ...
    function renderCertifications() {
        ...
        fill('section9',
            '<div class="container">'
            + '<div class="section-heading">'
            +   '<span class="section-eyebrow" data-i18n="certEyebrow">Recognition</span>'
            +   '<h2 data-i18n="certTitle">Certifications &amp; Awards</h2>'
            + '</div>'
    ...
    function renderEducation() {
        ...
        fill('section10',
            '<div class="container">'
            + '<div class="section-heading">'
            +   '<span class="section-eyebrow" data-i18n="eduEyebrow">Academic Background</span>'
            +   '<h2 data-i18n="eduTitle">Education</h2>'
            + '</div>'
    ...
    function renderSkills() {
        ...
        fill('section2',
            '<div class="container">'
            + '<div class="section-heading">'
            +   '<span class="section-eyebrow" data-i18n="skillsEyebrow">Expertise</span>'
            +   '<h2 data-i18n="skillsTitle">Skills &amp; Competencies</h2>'
            + '</div>'
    ...
    function renderContact() {
        ...
        mount.innerHTML =
            ...
            +     '<a href="' + esc(c.linkedin) + '" target="_blank" rel="noopener" class="btn btn-linkedin"><i class="fab fa-linkedin-in"></i>&nbsp; LinkedIn</a>'
            +   '</div>'
            +   '<a href="' + esc(D.profile.cvUrl) + '" class="btn btn-cv contact-cv" download><i class="fas fa-file-download"></i>&nbsp; Download CV / Résumé</a>'
            + '</div>'
            ...
            +       '<a href="mailto:' + esc(c.email) + '" class="cd-value">' + esc(c.email) + '</a>'
            +     '</div>'
            ...
            +   '</li>'
            +   '<li>'
            +     '<div class="cd-icon cd-icon--wa"><i class="fab fa-whatsapp"></i></div>'
            +     '<div class="cd-body">'
            +       '<span class="cd-label">WhatsApp</span>'
            +       '<a href="https://wa.me/' + esc(c.phone) + '" target="_blank" rel="noopener" class="cd-value">Send a message</a>'
            +     '</div>'
            +   '</li>'
            +   '<li>'
            +     '<div class="cd-icon cd-icon--li"><i class="fab fa-linkedin-in"></i></div>'
            +     '<div class="cd-body">'
            +       '<span class="cd-label">LinkedIn</span>'
            +       '<a href="' + esc(c.linkedin) + '" target="_blank" rel="noopener" class="cd-value">View profile</a>'
            +     '</div>'
            +   '</li>'
            +   '<li>'
            +     '<div class="cd-icon cd-icon--loc"><i class="fas fa-map-marker-alt"></i></div>'
            +     '<div class="cd-body">'
            +       '<span class="cd-label">Location</span>'
            +       '<span class="cd-value">' + esc(c.location) + '</span>'
            +     '</div>'
            +   '</li>'
            + '</ul>'
            + '</div>';
